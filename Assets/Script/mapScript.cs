            ...
            case 2:
                {
                    ...
                    new_enemy9.GetComponent<enemyScript>().Setup(10, 13, "Granius?", "Granius", 3, 3, "near", 1, 2, 6, 6, 90, 0, 3, 4, false, 25, 9, 3, 7, 10, 7, 5, 2, "Inconsistant One");
                    GameObject new_enemy10 = (GameObject)Instantiate(enemy, new Vector3(0, 0, 0), Quaternion.identity);
                    new_enemy10.GetComponent<enemyScript>().Setup(15, 13, "Thera?", "Thera", 3, 3, "near", 1, 1, 5, 5, 90, 0, 3, 7, false, 29, 10, 5, 5, 8, 6, 6, 3, "Inconsistant One");
                    break;
                }
