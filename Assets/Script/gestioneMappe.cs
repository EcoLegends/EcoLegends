...
public class gestioneMappe : MonoBehaviour
{
    ...
    void Start()
    {
        if (System.IO.File.Exists(Application.streamingAssetsPath+"completedMaps.txt") ==false){ //controlla file mappe completate
        ...
        if (System.IO.File.Exists(Application.streamingAssetsPath+"mappaScelta.txt") ==false){ //controlla file mappe scelta
